...
namespace comp680.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async System.Threading.Tasks.Task<IActionResult> EPL()
        {
            //Now define your asynchronous method which will retrieve all your pokemon.
            //Define your baseUrl
            string baseUrl = "http://site.api.espn.com/apis/v2/sports/soccer/eng.1/standings";
            //Have your using statements within a try/catch block
            try
            {
                //We will now define your HttpClient with your first using statement which will implements a IDisposable interface.
        ...
        public async System.Threading.Tasks.Task<IActionResult> NBA()
        {
            //Now define your asynchronous method which will retrieve all your pokemon.
            //Define your baseUrl
            string baseUrl = "http://site.api.espn.com/apis/v2/sports/basketball/nba/standings";
            //Have your using statements within a try/catch block
            try
            {
                //We will now define your HttpClient with your first using statement which will implements a IDisposable interface.
